...
(unless sublain-bookmark-mode-map
  (setq sublain-bookmark-mode-map
	(let ((map (make-sparse-keymap)))
	  ...
	  (define-key map "n" 'sublain-bookmark-next-line)
	  (define-key map "p" 'sublain-bookmark-previous-line)
	  (define-key map "q" 'bury-buffer)
	  map)))
...
(defun sublain-bookmark-next-line (n)
  (interactive "p")
  (next-line n))

(defun sublain-bookmark-previous-line (n)
  (interactive "p")
  (previous-line n))
...
(unless sublain-blame-mode-map
  (setq sublain-blame-mode-map
	(let ((map (make-sparse-keymap)))
	  ...
	  (define-key map "n" 'sublain-blame-next-line)
	  (define-key map "p" 'sublain-blame-previous-line)
	  (define-key map "q" 'bury-buffer)
...
(defun sublain-blame-next-line (&optional n)
  (interactive "p")
  (next-line n))

(defun sublain-blame-previous-line (&optional n)
  (interactive "p")
  (previous-line n))
